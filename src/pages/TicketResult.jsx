...
function TicketResult() {
  return (
    <>
      <NavBar />
      <main className="text-base flex bg-abumuda text-maintext">
        <div className="relative w-3/5 h-[920px] bg-avengers bg-no-repeat bg-cover">
          <div className="absolute gap-5 flex-col text-white px-28 pt-80 pb-60 bg-[#000000CC] w-full h-full flex ">
            <div className="w-72">
              <img src={Funtastix} alt="Funtastix" />
            </div>
            <div className="text-5xl font-bold">Thankyou For Purchasing</div>
            <div className="text-2xl text-[#FFFFFFB2] w-full max-w-xl">
        ...
        <div className="flex gap-6 justify-center w-2/5 flex-col items-center">
